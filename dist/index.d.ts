...
export type { DocumentStoreService, DocumentQuery, DocumentQueryResult, ReadConsistency, ReadOptions, WriteAcknowledgment, WriteOptions, QueryOperators, FilterValue, ScanOptions, AtomicOperations, BatchWriteOperations, TransactionContext, NativeOperation } from "./documentstore/DocumentStoreService";
