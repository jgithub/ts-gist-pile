...
describe('envUtil', () => {
  ...
  describe('isProductionLikeEnv', () => {
    it('should return true when NODE_ENV is "production"', () => {
      ...
      expect(isProductionLikeEnv()).to.be.true;
    });
    ...
    it('should return false when NODE_ENV is "development"', () => {
      ...
      expect(isProductionLikeEnv()).to.be.false;
    });
  ...
  describe('isDevelopmentLikeEnv', () => {
    it('should return true when NODE_ENV is "development"', () => {
      process.env.NODE_ENV = 'development';
      expect(isDevelopmentLikeEnv()).to.be.true;
    });
    ...
    it('should return false when NODE_ENV is "production"', () => {
      process.env.NODE_ENV = 'production';
      expect(isDevelopmentLikeEnv()).to.be.false;
    });
  ...
  describe('isStagingLikeEnv', () => {
    it('should return true when NODE_ENV is "staging"', () => {
      process.env.NODE_ENV = 'staging';
      expect(isStagingLikeEnv()).to.be.true;
    });
    ...
    it('should return false when NODE_ENV is "production"', () => {
      process.env.NODE_ENV = 'production';
      expect(isStagingLikeEnv()).to.be.false;
    });
